...
%PONER IMAGEN DE COMO SE DESARROLLA LA CONVERGENCIA DE LMS
...
%PONER IMAGEN DE COMO SE DESARROLLA LA CONVERGENCIA DE RLS

\subsubsection{LMS and RLS comparison} 
%PONER IMAGEN DE una versus la otra. Comparar.
